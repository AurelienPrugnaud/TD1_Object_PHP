...
<?php if(count($tabPromotions) > 0): ?>
    <table class="table mb-3 text-center">
        ...
        <?php foreach($tabPromotions as $index => $promotion): ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-warning me-3" href="/promotionModify/<?php echo $index?>" title="modify">Modifier</a>
                    <a class="btn btn-danger" href="/promotionDelete/<?php echo $index ?>" title="delete">Supprimer</a>
                </td>            </tr>
        <?php endforeach; ?>
    </table>
    <?php else: ?>
